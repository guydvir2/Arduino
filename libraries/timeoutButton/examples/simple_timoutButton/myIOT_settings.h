...
void startIOTservices()
{
    ...
    // iot.TOPICS_JSON["pub_gen_topics"][0].set("myHome/Messages");
    // iot.TOPICS_JSON["pub_gen_topics"][1].set("myHome/log");
    // iot.TOPICS_JSON["pub_gen_topics"][2].set("myHome/debug");

    // iot.TOPICS_JSON["pub_topics"][0].set("myHome/group/client/Avail");
    // iot.TOPICS_JSON["pub_topics"][1].set("myHome/group/client/State");

    // iot.TOPICS_JSON["sub_topics"][0].set("myHome/group/client");
    // iot.TOPICS_JSON["sub_topics"][1].set("myHome/All");

    // iot.TOPICS_JSON["sub_data_topics"][0].set("myHome/device1");
