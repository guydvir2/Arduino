...
void createMSG_JSON(char a[], const char *v0, const char *v1 = nullptr,
                    const char *v2 = nullptr, const char *v3 = nullptr,
...
bool gen_send(const char *key0, const char *value0,
              const char *key1 = nullptr, const char *value1 = nullptr,
              const char *key2 = nullptr, const char *value2 = nullptr,
              const char *key3 = nullptr, const char *value3 = nullptr,
...
bool send(const char *msg_type, const char *p0, const char *p1 = nullptr,
          const char *p2 = nullptr, const char *key[] = gKeys)
{
  char outmsg[250];
