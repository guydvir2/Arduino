...
String json_def_value = "{\"useSerial\":true,\"useWDT\":false,\"useOTA\":true,\"useResetKeeper\" : false,\"useFailNTP\" : true,\"useDebugLog\" : true,\"useDisplay\":false,\"deviceTopic\" : \"devTopic\",\"groupTopic\" : \"group\",\"prefixTopic\" : \"myHome\",\"useOnatBoot\" : false,\"usequickBoot\" : false,\"usedailyTO\" : true,\"useSafteyOff\" : true,\"useEEPROM_resetCounter\" : false,\"usePWM\" : true,\"useInput\" : false,\"useExtTrig\" : false,\"momentryButtorn\" : true,\"numSW\" : 1,\"debug_level\":2,\"safetyOffDuration\" : 60,\"inputPin\" : [0, 2],\"outputPin\":[12,5],\"extTrigPin\" : 5,\"hReboots\" : [1,2],\"start_dTO\" : [[19,0, 0],[20,30,0]],\"end_dTO\" : [[23,30,0],[22,0,0]],\"timeOUTS\" : [120,120],\"SW_Names\" : [\"LED1\",\"LED2\"]}";

extern int START_dTO[2][3];  // = {{19, 0, 0}, {21, 30, 0}};
extern int END_dTO[2][3];    // = {{23, 30, 0}, {22, 0, 0}};
extern int TimeOUT[2];       // = {10, 120}; // minutes
extern int outputPin[2];     // = {12, 5}; // D3 for most PWM boards
extern int inputPin[2];      // = {0, 2};	 // input is not for extTrig
extern int extTrigPin;       // = 5;
extern int hRebbots[2];      // = {1, 2};
extern char SW_Names[2][30]; // = {"LEDstrip", "Ledstrip"};
extern bool usePWM;
