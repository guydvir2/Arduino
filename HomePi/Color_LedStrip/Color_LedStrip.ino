...
int param_def_values[] = {COLOR, BRIGHTNESS, LED_DELAY, LED_DIRECTION, TRAIL_MODE};
...
void setup() {
        ...
        // ~~~~~~~~Start LED ~~~~~~~~
        start_LEDS();
        turn_leds_on(COLOR, BRIGHTNESS, 20,LED_DIRECTION, TRAIL_MODE);
}
...
void loop() {
        ...
        // if (millis()-lastShuffle>=random(100,shuffleClock)) {
        //         turn_leds_on(random(1,16), random(5,50), random(1,50),random(0,2), 0);
        //         lastShuffle=millis();
        // }
