...
bool indic_ON[MAX_NUM_SCHEDS] = {HIGH, LOW};
...
bool outputPWM[MAX_NUM_SCHEDS] = {false, true};
bool dimPWM[MAX_NUM_SCHEDS] = {true, true};

uint8_t trigType[MAX_NUM_SCHEDS] = {0, 0};          /* Input type */
uint8_t inputPin[MAX_NUM_SCHEDS] = {D5, D6};        /* IO for inputs */
uint8_t outputPin[MAX_NUM_SCHEDS] = {D1, D2};         /* IO for outputs */
uint8_t indicPin[MAX_NUM_SCHEDS] = {D3, D4};          /* IO for idication LEDS */
...
int defaultTimeout[MAX_NUM_SCHEDS] = {1, 2};
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ End ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
